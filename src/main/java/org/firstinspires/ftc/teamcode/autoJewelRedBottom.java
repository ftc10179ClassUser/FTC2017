...
@Autonomous(name = "Red Jewel Bottom", group = "auto")
public class autoJewelRedBottom extends Autonomous_Library {
    ...
    public void runOpMode() {
        ...
        move(left, right, center, 0.3, 0.3, 0, 80, "lturn");
        jewel.setPosition(0);
        sleep(300);
        ...
        switch (vuValue) {
            case 'R':
                ...
                move(left, right, center, 0.5, 0.5, 0, 28, "forward");
                break;

            case 'C':
                //move in position to score into the center cryptobox
                move(left, right, center, 0.5, 0.5, 0, 43, "forward");
                break;

            case 'L':
                //move in position to score into the right cryptobox
                move(left, right, center, 0.5, 0.5, 0, 54, "forward");
                break;
        ...
        move(left, right, center, 0, 0, 1, 8 , "lstrafe");
        sleep(200);
        move(left, right, center, 0.4, 0.4, 0, 95, "rturn");
        ...
        sleep(500);
        //turns around so that the side holding the glyph is facing towards the cryptobox
        move(left, right, center, 0.4, 0.4, 0, 180, "rturn");
        sleep(500);
        //go forward and score

        move(left, right, center, 0.5, 0.5, 0.5, 7, "backward");
