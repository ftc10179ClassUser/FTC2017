...
@Autonomous(name = "Blue Jewel Top", group = "auto")
public class autoJewelBlueTop extends Autonomous_Library {
    ...
    public void runOpMode() {
        ...
        sleep(1000);
        pulley.setPower(0);
        move(left, right, center, 0.3, 0.3, 0, 95, "rturn");
        sleep(300);
        ...
        switch (vuValue) {
            case 'L':
                ...
                move(left, right, center, 0, 0, 0.7, 3, "lstrafe");
                break;

            case 'C':
                //move in position to score into the center cryptobox
                move(left, right, center, 0, 0, 0.7, 18, "lstrafe");
                break;

            case 'R':
                //move in position to score into the right cryptobox
                move(left, right, center, 0, 0, 0.7, 23, "lstrafe");
                break;
